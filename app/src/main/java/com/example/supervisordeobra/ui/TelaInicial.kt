...
fun TelaInicial(navController: NavController) {
    ...
    Column(
        ...
        Column(modifier = Modifier.background(color = Color.White)) {
            Image(painter = painterResource(id = R.drawable.inserir_arquivo),
                contentDescription = "",
                modifier = Modifier
        ...
        Column(modifier = Modifier.background(color = Color.White)) {
            Image(painter = painterResource(id = R.drawable.supervisor_de_obra),
                contentDescription = "",
                modifier = Modifier
                    .clickable { navController.navigate("supervisao") }
                    .width(350.dp)
                    .height(150.dp)
                    .padding(10.dp))
        }
        Spacer(modifier = Modifier.size(6.dp))
        Column(modifier = Modifier.background(color = Color.White)) {
            Image(painter = painterResource(id = R.drawable.escavadeira),
                contentDescription = "",
                modifier = Modifier
        ...
        Spacer(modifier = Modifier.size(6.dp))
        Column(modifier = Modifier.background(color = Color.White)) {
            Image(painter = painterResource(id = R.drawable.grau_de_compactacao),
                contentDescription = "",
                modifier = Modifier
